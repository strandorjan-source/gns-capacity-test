...
test('winter midnight and future availability use the Norwegian date', () => { assert.equal(osloDate('2026-12-18T23:00:00Z'),'2026-12-19'); assert.equal(isHistorical({available_at:'2026-12-19T23:30:00Z'},'2026-12-19'),false); });
